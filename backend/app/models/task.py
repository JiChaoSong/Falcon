...
from sqlalchemy import Integer, String, Text, DateTime, Enum as SQLAlchemyEnum
...
class Tasks(BaseModel):
    ...
    owner_id: Mapped[int] = mapped_column(Integer , nullable=False, comment="任务负责人id")
...
class TaskScenario(BaseModel):
    ...
    scenario_id: Mapped[int] = mapped_column(Integer, nullable=False, comment="场景id")
